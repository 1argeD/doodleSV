...
public class TestController {
    ...
    ResponseEntity<?> testEnter(@AuthenticationPrincipal UserDetailsImpl userDetails, @PathVariable String canvasId) {
      log.info("연결이 되면 이걸 보여줌");
      websocketController.enter(userDetails.getMember().getId(),canvasId);
